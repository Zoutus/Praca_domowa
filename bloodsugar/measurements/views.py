...
def measurement_list(request):
    ...
    return render(request, 'measurements/measurements_list.html', {'measurements': measurements})


def measurement_details(request, id):
    measurement = Measurement.objects.get(id=id)
    return render(request, "measurements/measurements_details.html", {"measurement": measurement})
...
def measurement_delete(request, id):
    ...
    return render(request, 'measurements/measurements_delete.html', {"measurement": measurement})